...
export default function PickupAgentLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post('/api/pickup-agents/login', {
        email,
        password
      });
      ...
      // Set the user with pickup agent data
      const userData = {
        id: agent.id,
        name: agent.name,
        email: agent.email,
      ...
      setUser(userData);
      navigate('/pickup-agent/dashboard');
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-pink-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-pink-700 bg-clip-text text-transparent">
            Agent Portal
          </h2>
          <p className="mt-2 text-sm text-gray-600">
            Sign in to your pickup agent account
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="mt-6 text-center">
            ...
            <div className="mt-2 text-sm text-gray-600">
              Need help? Contact{' '}
              <a href="mailto:support@company.com" className="font-medium text-purple-600 hover:text-purple-500">
                support
              </a>
            </div>
          </div>
