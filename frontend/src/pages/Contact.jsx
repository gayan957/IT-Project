...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-4">
              Contact <span className="text-yellow-400">Trash2Cash</span>
            </h1>
            <p className="text-xl text-emerald-100 max-w-3xl mx-auto">
              Get in touch with our team. We're here to help you turn your waste into cash and make Sri Lanka cleaner.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Have questions about our waste management platform? Need support with your account? 
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-emerald-100 hover:shadow-xl transition-shadow">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">No 23/A, Kandy Road, Malabe, Sri Lanka</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-cyan-100 hover:shadow-xl transition-shadow">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">partnerships@trash2cash.lk</p>
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                className={`w-full py-4 px-6 rounded-xl font-semibold text-lg transition-all duration-300 ${
                  isSubmitting
                    ...
                    : 'bg-gradient-to-r from-emerald-600 to-teal-600 text-white hover:from-emerald-700 hover:to-teal-700 hover:shadow-lg transform hover:scale-[1.02]'
                }`}
              >
                {isSubmitting ? (
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600">
                Visit our headquarters in Malabe, Sri Lanka
              </p>
            </div>
            ...
            <div className="w-full h-96 bg-gray-100 rounded-2xl flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-1">No 23/A, Kandy Road, Malabe, Sri Lanka</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Quick answers to common questions about Trash2Cash
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">
                How do I start earning with Trash2Cash?
              </h3>
              <p className="text-gray-600">
                Simply register on our platform, schedule a waste pickup, and start earning money for your recyclable waste. It's that easy!
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                We accept plastic, paper, glass, metal, organic waste, and select electronic items. Check our Services page for detailed information.
              </p>
            </div>

            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">
                How are waste prices determined?
              </h3>
              <p className="text-gray-600">
                Our AI-powered system calculates fair market prices based on current recycling rates, demand, and waste quality.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                Payments are processed within 24-48 hours after your waste is collected and verified. You can track all transactions in your dashboard.
              </p>
            </div>
          </div>
        </div>
