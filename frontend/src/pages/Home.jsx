...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className={`text-center lg:text-left transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className={`flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8 transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                ...
                <Link
                  to="/services"
                  className="group bg-cyan-500 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-cyan-400 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl relative overflow-hidden"
                >
      ...
      {/* Statistics Section */}
      <section className="py-20 bg-gradient-to-br from-emerald-500 via-teal-500 to-emerald-600 text-white relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0" style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23ffffff' fill-opacity='0.05'%3E%3Cpath d='m0 40l40-40h-40v40z'/%3E%3C/g%3E%3C/svg%3E")`,
          }} />
        </div>

        {/* Floating Animation Elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-10 left-10 w-32 h-32 bg-teal-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
          <div className="absolute bottom-10 right-10 w-40 h-40 bg-emerald-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-bounce"></div>
          <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-cyan-400 rounded-full mix-blend-multiply filter blur-xl opacity-15 animate-ping"></div>
        </div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-on-scroll">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Our <span className="bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">Impact</span>
            </h2>
            <p className="text-xl text-emerald-100 max-w-3xl mx-auto">
              Join thousands of users making a real difference in Sri Lanka's waste management
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {/* Kilograms Recycled */}
            <div className="text-center group animate-on-scroll" style={{ animationDelay: '0.1s' }}>
              <div className="relative mb-6">
                <div className="w-20 h-20 md:w-24 md:h-24 mx-auto bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-white/20">
                  <svg className="w-10 h-10 md:w-12 md:h-12 text-yellow-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-2">
                <div className="text-3xl md:text-4xl font-bold text-white counter" data-target="25000">25,000+</div>
                <div className="text-sm md:text-base text-emerald-100 font-medium">Kilograms Recycled</div>
              </div>
            </div>
            ...
            <div className="text-center group animate-on-scroll" style={{ animationDelay: '0.2s' }}>
              <div className="relative mb-6">
                <div className="w-20 h-20 md:w-24 md:h-24 mx-auto bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-white/20">
                  <svg className="w-10 h-10 md:w-12 md:h-12 text-yellow-300" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M16 4c0-1.11.89-2 2-2s2 .89 2 2-.89 2-2 2-2-.89-2-2zm4 18v-6h2.5l-2.54-7.63A1.5 1.5 0 0 0 18.5 7h-5c-.8 0-1.5.7-1.5 1.5v6c0 .8.7 1.5 1.5 1.5h2v6h4zM12.5 11.5c.83 0 1.5-.67 1.5-1.5s-.67-1.5-1.5-1.5S11 9.17 11 10s.67 1.5 1.5 1.5zM5.5 6c1.11 0 2-.89 2-2s-.89-2-2-2-2 .89-2 2 .89 2 2 2zm2 16v-7H9V9c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v6h1.5v7h4z"/>
                  </svg>
                </div>
              </div>
              <div className="space-y-2">
                <div className="text-3xl md:text-4xl font-bold text-white counter" data-target="5500">5,500+</div>
                <div className="text-sm md:text-base text-emerald-100 font-medium">Active Users</div>
              </div>
            </div>

            {/* Earned by Users */}
            <div className="text-center group animate-on-scroll" style={{ animationDelay: '0.3s' }}>
              <div className="relative mb-6">
                <div className="w-20 h-20 md:w-24 md:h-24 mx-auto bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-white/20">
                  <svg className="w-10 h-10 md:w-12 md:h-12 text-yellow-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-2">
                <div className="text-3xl md:text-4xl font-bold text-white counter" data-target="180000">Rs 1.8M+</div>
                <div className="text-sm md:text-base text-emerald-100 font-medium">Earned by Users</div>
              </div>
            </div>
            ...
            <div className="text-center group animate-on-scroll" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="space-y-2">
                <div className="text-3xl md:text-4xl font-bold text-white counter" data-target="150">150+</div>
                <div className="text-sm md:text-base text-emerald-100 font-medium">Partner Locations</div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-16 animate-on-scroll" style={{ animationDelay: '0.5s' }}>
            <p className="text-lg md:text-xl text-emerald-100 mb-8 max-w-2xl mx-auto">
              Be part of Sri Lanka's sustainable future. Start recycling today and earn while protecting our environment.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/register" 
                className="group bg-white text-emerald-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-emerald-50 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105 relative overflow-hidden"
              >
              ...
              <Link 
                to="/services" 
                className="group border-2 border-white text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-emerald-600 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105 relative overflow-hidden"
              >
                <span className="relative z-10 flex items-center justify-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
